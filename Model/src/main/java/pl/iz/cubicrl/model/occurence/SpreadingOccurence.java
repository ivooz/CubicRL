 ...
 * @author Ivo
 */
public class SpreadingOccurence extends TimedOccurenceWithEffects {
	...
	/**
	 * Occurences added this turn should start spreading next turn
	 */
	 ...
	 * @param initialTimer
	 * @param degradationRate new spawned effects will last initialTimer-degradationRate turns
	 */
	public SpreadingOccurence(String name, Coords2D spriteSheetCoordinates, Room room, double spreadChance, int initialTimer, int degradationRate) {
